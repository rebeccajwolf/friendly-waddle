...
export class HostRulesManager {
    ...
    private initializeHostRules(): void {
        this.hostRules.set('rewards.bing.com', '150.171.30.10') // Updated IP
        this.hostRules.set('www.bing.com', '2.18.67.162') // Use first IP from resolution
        this.hostRules.set('account.microsoft.com', '150.171.30.10') // Same as rewards
        this.hostRules.set('prod.rewardsplatform.microsoft.com', '13.107.213.40') // Updated
        ...
        this.hostRules.set('discord.com', '162.159.135.232') // Updated to first resolved IP
    }
